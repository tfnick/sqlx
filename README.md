...
In addition to the [godoc API documentation](http://godoc.org/github.com/tfnick/sqlx),
...
[sqlx_test.go](https://github.com/tfnick/sqlx/blob/master/sqlx_test.go) for more
usage.
